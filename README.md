...
### DkZ Action Builder -- Einzelne Aktionen definieren, konfigurieren und testen
...
![Lines](https://img.shields.io/badge/Lines-1047-ffb800?style=for-the-badge)
...
```bash
# Clone
git clone https://github.com/7IKED/dkz-action-builder.git

# Oeffnen
cd dkz-action-builder
